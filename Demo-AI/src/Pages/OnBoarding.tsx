...
import {Alert, Button, Card, CardContent, Divider, Fade, Grid, Stack, TextField, Typography} from '@mui/material';
                    ...
                    <Card sx={{borderRadius: 4}}>
                        <CardContent>
                            <Stack spacing={3}>
                                ...
                                <Typography variant="subtitle1">Bevor wir weitermachen, nenne mir bitte deine
                                    Interessen.</Typography>
                                ...
                                <TextField label="Was interessiert dich?"
                                           placeholder='z.B. Mathe, Fußball oder Geschichte' variant="outlined"
                                           fullWidth margin="normal" value={interestsInput}
                                           onChange={(e) => setInterestsInput(e.target.value)} error={alertOpen}/>
                                <Button variant="contained" fullWidth onClick={handleSubmit}
                                        endIcon={<MeetingRoomIcon/>} disabled={interests.length === 0}>
                                    <Typography variant="button">Zur Fächerauswahl</Typography>
                                </Button>

                                <Divider aria-hidden="true" orientation="horizontal" textAlign="center">
                                    <Typography variant="caption">Demo-Version: Interessen werden nicht
                                        gespeichert!</Typography>
                                </Divider>
                            </Stack>
                        </CardContent>
                    </Card>
